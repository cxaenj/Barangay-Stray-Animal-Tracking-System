    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 xl:w-3/5 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute bottom-40 right-10 w-16 h-16 border-4 border-white rounded-full"></div>
          <div className="absolute top-1/3 left-1/2 w-40 h-40 border-4 border-white rounded-full"></div>
        </div>
